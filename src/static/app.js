                ...
                <ul class="participants-list" style="list-style-type: none; padding-left: 0;">
                  ${details.participants.map(email => `
                    <li style="display: flex; align-items: center; gap: 6px;">
                      <span>${email}</span>
                      <span class="delete-participant" title="Remove" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(email)}" style="cursor:pointer;color:#c62828;font-weight:bold;font-size:1.1em;">&#10006;</span>
                    </li>
                  `).join("")}
                </ul>
              </div>
